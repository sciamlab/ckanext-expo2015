...
class MultilingualResource(SingletonPlugin):
   '''The MultilinguaResource plugin translate resource names on resource
   preview page
   '''
   ...
   def before_show(self, data_dict):
        #print("### Alessio ---------------------------------------------------------------------------") 
        #print("### Alessio NON-TRANSLATED:",data_dict['name'])
        #self,data_dict)
        translated_data_dict = translate_resource_data_dict(data_dict)
        #print("### Alessio TRANSLATED:",translated_data_dict)
        return translated_data_dict
